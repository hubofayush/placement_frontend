// after loading screen set up password page will display
...
const LoadingSplashScreens = ({ navigation }) => {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      navigation.navigate("PasswordSetup"); // Navigate to SetupProfile
...
export default LoadingSplashScreens;
