...
const CompanyAccountCreated = ({ navigation }) => {
  ...
  const handleSave = () => {
    ...
    navigation.navigate("CompanyMarketplace");
  };
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.mainContent}>
        ...
        <Text style={styles.title}>Finolex Industry</Text>
        ...
        <View style={styles.successMessageContainer}>
          ...
          <Text style={styles.successText}>
            You can now post jobs using your account as a portfolio.
          </Text>
...
export default CompanyAccountCreated;
